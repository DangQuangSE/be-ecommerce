...
- **Customer seed (tùy chọn, chỉ dev):** `APP_CUSTOMER_SEED_ENABLED=true`, `APP_CUSTOMER_EMAIL`, `APP_CUSTOMER_PASSWORD` — tạo tài khoản sample customer khi API khởi động (xem `.env.example`)

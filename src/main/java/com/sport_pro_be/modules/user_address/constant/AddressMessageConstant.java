package com.sport_pro_be.modules.user_address.constant;

public class AddressMessageConstant {
    public static final String ADDRESS_NOT_FOUND = "ADDRESS_NOT_FOUND";
    public static final String ADDRESS_LIMIT_REACHED = "ADDRESS_LIMIT_REACHED";
    public static final String ADDRESS_CREATED = "ADDRESS_CREATED_SUCCESSFULLY";
    public static final String ADDRESS_UPDATED = "ADDRESS_UPDATED_SUCCESSFULLY";
    public static final String ADDRESS_DELETED = "ADDRESS_DELETED_SUCCESSFULLY";
